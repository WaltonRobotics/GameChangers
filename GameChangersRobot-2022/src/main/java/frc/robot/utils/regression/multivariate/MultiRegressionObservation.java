...
// Feature and value pairs include both the dependent and independent variables
public class MultiRegressionObservation {
    private final LinkedHashMap<String, Double> features = new LinkedHashMap<String, Double>();
