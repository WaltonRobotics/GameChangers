...
public class Climber extends SubsystemBase {
    ...
    private final Solenoid mLockSolenoid = new Solenoid(PneumaticsModuleType.CTREPCM, kClimberLockSolenoidID);
    private final Solenoid mDeploySolenoid = new Solenoid(PneumaticsModuleType.CTREPCM, kClimberDeploySolenoidID);
